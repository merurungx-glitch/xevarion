...
function loadMbCore() {
  ...
  return loadScriptOnce("../MagiBurst/js/mb-core.js?v=100");
}
...
async function loadMbDetail() {
  ...
  if (!$('link[data-mbdet]')) {
    ...
    l.rel = "stylesheet"; l.href = "../mb-char-detail.css?v=21"; l.setAttribute("data-mbdet", "1");
  ...
  if (typeof window.openDetX !== "function") await loadScriptOnce("../mb-char-detail.js?v=26");
  _mbDetailReady = true;
}
