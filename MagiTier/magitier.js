...
async function loadMbDetail() {
  ...
  if (!$('link[data-mbdet]')) {
    ...
    l.rel = "stylesheet"; l.href = "../mb-char-detail.css?v=23"; l.setAttribute("data-mbdet", "1");
  ...
  if (typeof window.openDetX !== "function") await loadScriptOnce("../mb-char-detail.js?v=34");
  _mbDetailReady = true;
}
