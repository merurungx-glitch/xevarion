...
const XH_UPDATES = [
  ...
  { tag:"FIX", t1:"MagiScope のセールが出ない不具合を修正", at:"2026-09-21",
    ...
    href:"MagiScope/index.html", img:"thumbs/MagiScope.jpg" },
  /* ★★ 2026-09-21g MagiScope 操作の仕上げ */
  { tag:"UPDATE", t1:"MagiScope の使い心地を改善", at:"2026-09-21",
    t2:"同じ並べ替え・絞り込みを押すと解除／閉じるは右上の✕／ジャンル・作者・検索は全作品で表示／全作品のランキング順を修正／横長の絵を大きく・左端にくっつくのを修正／サンプルの位置を固定／順位推移のグラフを廃止",
    href:"MagiScope/index.html", img:"thumbs/MagiScope.jpg" },
  /* ★★ 2026-09-21f MagiScope 新作・セール情報／MagiShift の登録 */
  { tag:"UPDATE", t1:"MagiScope に新作・セール情報", at:"2026-09-21",
    t2:"新作タブ（アニメは今季・来季）とセール情報タブを追加・値下がりタブは廃止／この作品を見た人が見ている作品／レビューを最大10〜12件／並べ替え・絞り込みはボタンから縦の一覧で／FANZA同人本は約400位まで",
    href:"MagiScope/index.html", img:"thumbs/MagiScope.jpg" },
  { tag:"UPDATE", t1:"MagiShift の登録を MagiChainParty と同じに", at:"2026-09-21",
    t2:"名前はその場で打ちかえ・🔗で XEVARION アカウントを紐づけ・前回の紐づけは🔒で4桁パスワードを確認",
    href:"MagiShift/index.html", img:"thumbs/MagiShift.jpg" },
  /* ★★ 2026-09-21e MagiScope 全作品・セール・値下がりのタブ／スマホ／同期 */
  { tag:"UPDATE", t1:"MagiScope に全作品・セール・値下がり", at:"2026-09-21",
    t2:"下のタブに全作品・セール・値下がりを追加／ランキングの絞り込みはランキング内だけ／並べ替えはどれでも効き、逆順も／スマホで画面が横にずれるのを修正／アイコンは XEVARION のもの／お気に入り・履歴は端末どうしで足しあわせて同期",
    href:"MagiScope/index.html", img:"thumbs/MagiScope.jpg" },
