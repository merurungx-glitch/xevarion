...
(function () {
  ...
  const POOL_NM = {
    ...
    fes: ["Nocturne Bloom Fest", "フェス限定★5。プレミアムからは出ない。消費は🎫フェスチケット（フェス専用）→🎫ガチャチケット（全ガチャ共通・2026-08-13 新設）→💎ジェムの順。"],
  ...
  const FAQ = [
    ...
    { id: "gacha", q: ["ガチャ", "召喚", "確定", "天井", "排出", "10連", "ピックアップ"],
      ...
      a: "XEVARION 本体の<b>XEVAガチャ</b>と、MagiBurst の<b>プレミアムセレクトガチャ</b>（ジェム）があります。<br>" +
        ...
        "フェス限定★5はプレミアムからは出ません。<b>Nocturne Bloom Fest</b> で、🎫ガチャチケット（どのガチャでも使える共通チケット）があれば優先して消費されます。" },
