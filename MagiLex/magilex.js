...
window.lexKpDetail = async function(id){
  ...
  try{
    ...
    if(typeof window.CHARS === "undefined") await _loadScript("../MagiBurst/js/mb-core.js?v=129");
    if(typeof window.openDetX !== "function") await _loadScript("../mb-char-detail.js?v=35");
    _kpDetReady = true;
    _kpOpen(id);
  }catch(e){
