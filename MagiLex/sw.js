...
const CORE = [
  ...
  "./magilex-eigo.js?v=4",
  "./magilex-rika.js?v=4",
  "./magilex-butsuri.js?v=5",
  "./magilex-chemb.js?v=5",
  "./magilex-math3.js?v=4",
  "./magilex-chemg.js?v=6",
  "./magilex-suugaku.js?v=6",
  "./magilex-intro.js?v=4",
  "./magilex-mid.js?v=4",
  "./magilex-chemd.js?v=4",
  "./magilex-physb.js?v=4",
  /* ★★ 2026-08-26 化学ε・物理γ（全範囲の標準演習。各20セット240問）。
     ここに無いとオフラインでこの2科目だけ問題が出てこない。 */
  "./magilex-cheme.js?v=6",
  "./magilex-physg.js?v=5",
  /* ★★ 2026-08-30 地理。ここに無いとオフラインで開けず、update.json にも載らない。 */
  "./magilex-chiri.js?v=4",
  "./mlhome_s.jpg",
