...
const CORE = [
  ...
  "./magilex-eigo.js?v=8",
  "./magilex-rika.js?v=8",
  "./magilex-butsuri.js?v=9",
  "./magilex-chemb.js?v=9",
  "./magilex-math3.js?v=8",
  "./magilex-chemg.js?v=10",
  "./magilex-suugaku.js?v=10",
  "./magilex-intro.js?v=8",
  "./magilex-mid.js?v=8",
  "./magilex-chemd.js?v=8",
  "./magilex-physb.js?v=8",
  /* ★★ 2026-08-26 化学ε・物理γ（全範囲の標準演習。各20セット240問）。
     ここに無いとオフラインでこの2科目だけ問題が出てこない。 */
  "./magilex-cheme.js?v=10",
  "./magilex-physg.js?v=9",
  /* ★★ 2026-08-30 地理。ここに無いとオフラインで開けず、update.json にも載らない。 */
  "./magilex-chiri.js?v=8",
  "./mlhome_s.jpg",
