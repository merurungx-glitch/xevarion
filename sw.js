/* ============================================================
   ...
   ============================================================ */
const VERSION = "xevarion-sw-v121";
...
const CORE = [
  ...
  "./xevion-os.js?v=8",
  "./xevion-os.css?v=10",
  "./magibattle-stats.js?v=9",
  "./MagiBurst/js/mb-core.js?v=89",
  /* ★ 2026-08-10 ガチャと図鑑で共通の土台・キャラ詳細・結果演出 */
  /* ★ 2026-08-12 ポータルのガチャ・図鑑も magiburst_v1 を同期するようになった */
  "./app-cloud.js?v=7",
  "./MagiBurst/magiburst-cloud.js?v=9",
  "./mb-boot.js?v=12",
  "./mb-char-detail.js?v=22",
  "./mb-char-detail.css?v=17",
  "./mb-gacha-reveal.css?v=6",
  "./community.html",
  "./about.html",
  "./manifest.webmanifest",
  "./xeva-theme.css?v=4",
  "./xevarion.css?v=19",
  "./xevarion-home.css?v=53",
  /* ★★ 2026-09-03 下バーを画面の下端に合わせる共通部品 */
  "./xeva-safebottom.js?v=4",
  "./xeva-collection.js?v=2",
  "./xeva-i18n.js?v=3",
  ...
  "./MagiDiamond/css/md2.css?v=5",
  "./MagiDiamond/css/md2-ui.css?v=7",
  "./xeva-i18n-md1.js?v=6",
  "./MagiDiamond/img/icon.png?v=1",
  "./MagiDiamond/img/icon192.png?v=1",
  "./MagiDiamond/img/favicon32.png?v=1",
  "./MagiDiamond/img/icon.webp?v=1",
  "./MagiDiamond/img/icon192.webp?v=1",
  "./MagiDiamond/js/md2-data.js?v=7",
  "./MagiDiamond/js/md2-game.js?v=17",
  "./MagiDiamond/js/md2-online.js?v=5",
  ...
  "./thumbs/xevarion-home_s.jpg?v=6",
];
