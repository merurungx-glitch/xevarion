/* ============================================================
   ...
   ============================================================ */
const VERSION = "xevarion-sw-v137";
...
const CORE = [
  ...
  "./MagiDiamond/css/md2.css?v=9",
  "./MagiDiamond/css/md2-ui.css?v=11",
  "./xeva-i18n-md1.js?v=10",
  "./MagiDiamond/img/icon.png?v=5",
  "./MagiDiamond/img/icon192.png?v=5",
  "./MagiDiamond/img/favicon32.png?v=5",
  "./MagiDiamond/img/icon.webp?v=5",
  "./MagiDiamond/img/icon192.webp?v=5",
